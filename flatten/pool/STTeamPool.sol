...
// File contracts/pool/STTeamPool.sol


pragma solidity >=0.8.12;
/**
 * @title ST Team Pool Contract
 * @author SEALEM-LAB
 * @notice In this contract team users can harvest ST
 */
contract STTeamPool is ReentrancyGuard {
    ...
    uint256 public constant releasedTotalToken = 5e6 * 1e18;
    uint256 public constant releaseTerm = 20 * blockPerQuarter;
    uint256 public constant releaseStartBlock = stStartBlock;
